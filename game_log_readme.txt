...
Some of the databases available incorporate Retrosheet ID codes. These are of the 
form "llllfnnn" where "llll" are the first four letters of the last name, "f" is 
the first letter of the first name, and "nnn" are numbers. The first number is 0 
for players who appeared in 1984 or later, 1 for players whose career ended before
 1984, 8 for managers and coaches who never played in the majors, and 9 for umpires 
 who never played. The next two numbers are sequence numbers starting with 01.
LAST,FIRST,ID,DEBUT
